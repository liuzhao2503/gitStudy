// pages/Setup/modifypaymentm/modifytelpaymentm.js
...
Page({
    ...
    bangtelbtn: function () {
        ...
        var qrnewpassword = that.data.qrnewpassword;
        if (yz != "") {
            wx.showLoading({
                title: '加载中',
                mask: true
